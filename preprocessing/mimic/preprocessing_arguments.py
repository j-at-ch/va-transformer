...
class PreprocessingArguments:
    ...
    def initialise(self):
        ...
        self.parser.add_argument('--labs_preliminaries_done', type=int, default=1)
        ...
        self.parser.add_argument('--sentinel_mean', type=float, default=-100)
        self.parser.add_argument('--sentinel_count', type=float, default=-100)
        self.parser.add_argument('--sentinel_latest', type=float, default=-100)
